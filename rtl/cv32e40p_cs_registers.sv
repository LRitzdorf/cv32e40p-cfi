...
#(
  ...
  localparam MSTATUS_MPELP_BIT = 23;
  ...
  logic [31:0] mseccfg_q, mseccfg_n;
  logic        mpelp_q, mpelp_n;
  ...
  //  Zicfilp ELP save across traps
  always_ff @(posedge clk, negedge rst_n)
    if (!rst_n) mpelp_q <= 1'b0;
    else        mpelp_q <= mpelp_n;
